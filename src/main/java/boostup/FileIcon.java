...
public class FileIcon {
    ...
    public static String word = fileTypeLoadIcon+"word.png";
    public static String excel = fileTypeLoadIcon+"excel.png";
    public static String PPT = fileTypeLoadIcon+"ppt.png";
